...
from storm.common import Controller, Get, Logger, NotFoundException, Param, ParseIntPipe, Query
...
class NotesController:
    ...
    @Get()
    @Query("q")
    async def get_notes(self, user_id: int = Param("user_id", ParseIntPipe), q: str = None):
